;; 4 parallel 3-step A/B equality ladders over disjoint variables;
...
(set-option :solver.proof.log wide4_proof.smt2)
...
(assert (and
          ...
          (or (not (= x0_0 x0_3)) (not (= x1_0 x1_3)) (not (= x2_0 x2_3)) (not (= x3_0 x3_3)))
        ))
